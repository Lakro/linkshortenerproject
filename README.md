...
This project uses the [Geist](https://vercel.com/font) font family, loaded locally from the `geist` package. Geist is used as the main sans-serif font, and Geist Mono is used for monospace text (code blocks, etc.).
